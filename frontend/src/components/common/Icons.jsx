/**
 * Novara AI – Centralized SVG Icon Library
 * All icons are inline SVGs. Zero dependencies. Tree-shakeable.
 * Usage: <IconSend size={20} className="..." />
 */
...
const icon = (path, opts = {}) => {
  ...
  return function SvgIcon({ size = defaultSize, className = "", style, "aria-hidden": ariaHidden = true }) {
    return (
      <svg
...
export const IconContinue = icon(
  <>
...
export const IconGoogle = ({ size = defaultSize, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
